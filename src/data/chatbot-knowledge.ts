import branchesData from "../../content/shared/branches.json";
...
const branchList = BRANCHES.map(
  (b) => `• ${b.name} (${b.city}) — ${b.address} | ${b.phone}`
).join("\n");

export const CHAT_WELCOME = `Hello! 👋 I'm the ${BUSINESS.shortName} assistant. I can help you with remittance, Orange Money, mobile money, branches, fees, and more. What would you like to know?`;
...
export const CHAT_INTENTS: ChatIntent[] = [
  {
    ...
    response: CHAT_WELCOME,
    suggestions: QUICK_QUESTIONS,
  },
  {
    id: "thanks",
    keywords: ["thank", "thanks", "appreciate", "helpful"],
    response: "You're welcome! If you have any other questions about remittance or our services, feel free to ask. You can also visit any branch or call us directly.",
  ...
  },
  {
    id: "send-money",
    keywords: [
      "send money", "send cash", "transfer money", "how to send", "sending",
      "send abroad", "international transfer", "remit", "remittance send",
    ],
  ...
  },
  {
    id: "receive-money",
    keywords: [
      "receive money", "collect money", "pick up", "pickup", "how to receive",
      "getting money", "cash out remittance", "receive transfer",
    ],
  ...
  },
  {
    id: "orange-money",
    keywords: [
      "orange money", "orange", "orange cash", "orange wallet",
  ...
  },
  {
    id: "afrimoney",
    keywords: [
      "afrimoney", "afri money", "mobile money", "momo", "wallet",
      "africell", "mobile cash",
    ],
    response: `We offer Afrimoney and local mobile money agent services:\n\n• Cash-in and cash-out\n• Peer-to-peer transfers\n• Account registration support\n• Balance inquiries\n\nOur trained agents at every branch can assist with all mobile money transactions.`,
    suggestions: ["Orange Money services", "Branch locations"],
  },
  {
    id: "branches",
    keywords: [
      "branch", "branches", "location", "locations", "address", "where",
      "near me", "find branch", "office", "agent location",
    ],
  ...
  {
    id: "hours",
    keywords: ["hour", "hours", "open", "close", "closing", "opening", "time", "schedule", "when open"],
  ...
  {
    id: "fees",
    keywords: ["fee", "fees", "charge", "charges", "cost", "price", "rate", "how much", "expensive", "cheap"],
  ...
  {
    id: "documents",
    keywords: ["id", "identification", "document", "documents", "passport", "license", "voter", "required", "bring"],
  ...
  {
    id: "contact",
    keywords: ["contact", "phone", "call", "email", "reach", "speak", "talk", "whatsapp"],
  ...
  {
    id: "bill-payments",
    keywords: ["bill", "bills", "payment", "utility", "electricity", "water", "school fee", "school fees"],
  ...
  {
    id: "tracking",
    keywords: ["track", "tracking", "reference", "control number", "mtcn", "status", "where is my"],
